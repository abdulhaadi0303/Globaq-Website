      ...
      <div className={`mobile-menu ${isOpen ? "open" : ""}`}>
        <nav>
          <ul>
            ...
            <li>
              <div
                className={`dropdown-title ${showManagementDropdown ? "open" : ""}`}
                onClick={() => setShowManagementDropdown(!showManagementDropdown)}
              >
                Management System Audits
              </div>
              <div className={`dropdown-content ${showManagementDropdown ? "open" : ""}`}>
                <ul>
                  <li>
            ...
            <li>
              <div
                className={`dropdown-title ${showTrainingsDropdown ? "open" : ""}`}
                onClick={() => setShowTrainingsDropdown(!showTrainingsDropdown)}
              >
                Trainings
              </div>
              <div className={`dropdown-content ${showTrainingsDropdown ? "open" : ""}`}>
                <ul>
                  <li>
            ...
            <li>
              <div
                className={`dropdown-title ${showConsultancyDropdown ? "open" : ""}`}
                onClick={() => setShowConsultancyDropdown(!showConsultancyDropdown)}
              >
                ISO Consultancy
              </div>
              <div className={`dropdown-content ${showConsultancyDropdown ? "open" : ""}`}>
                <ul>
                  <li
                    onClick={() =>
            ...
            <li>
              <div
                className={`dropdown-title ${showAssistanceDropdown ? "open" : ""}`}
                onClick={() => setShowAssistanceDropdown(!showAssistanceDropdown)}
              >
                Audit Assistance
              </div>
              <div className={`dropdown-content ${showAssistanceDropdown ? "open" : ""}`}>
                <ul>
                  <li
                    onClick={() =>
            ...
            <li>
              <div
                className={`dropdown-title ${showLabServicesDropdown ? "open" : ""}`}
                onClick={() => setShowLabServicesDropdown(!showLabServicesDropdown)}
              >
                Lab Quality Management System Services
              </div>
              <div className={`dropdown-content ${showLabServicesDropdown ? "open" : ""}`}>
                <ul>
                  <li>Consultancy</li>
                  <li>
