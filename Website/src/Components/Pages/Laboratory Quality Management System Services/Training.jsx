    ...
    return (
        <div className="page-container">
            <div className="textbox">
                ...
                <h2>ISO/IEC 17025:2017 Awareness Training</h2>
                <p>
                ...
                <h2>ISO/IEC 17025:2017 Internal Auditor Training</h2>
                <p>
                ...
                <h2>Measurement Uncertainty Training</h2>
                <p>
                ...
                <h2>Proficiency Testing Training</h2>
                <p>
                ...
                <h2>Root Cause Analysis Training</h2>
                <p>
